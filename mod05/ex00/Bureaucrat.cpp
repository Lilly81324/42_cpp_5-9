...
/*   Updated: 2025/07/31 18:13:09 by sikunne          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Default Constructor
Bureaucrat::Bureaucrat(void): name("John Bureaucrat"), grade(DEF_GRADE)
{
...
Bureaucrat::Bureaucrat(int grade): name("John Bureaucrat"), grade(DEF_GRADE)
{
...
Bureaucrat& Bureaucrat::operator=(const Bureaucrat& other)
{
	if (this != &other)
		*this = other;
	std::cout << "Asignement Bureaucrat Operator called on " \
	<< this->name << " grade " <<this->grade << std::endl;
	return (*this);
}
